...
<div class="my-collections-grid" data-user-id="<?php echo $current_user_id; ?>"
    data-books-per-row="<?php echo esc_attr($books_per_row); ?>">
        ...
        <div class="collections-search-section">
            <div class="search-filters">
                <div class="search-input-group">
                    ...
                    <button type="button" class="search-clear"
                        title="<?php _e('Effacer la recherche', 'bdcomic_theme'); ?>">
            ...
            <div class="view-filters">
                <div class="filter-buttons">
                    <button type="button" class="filter-btn active" data-filter="owned">
                        <?php _e('Possédés', 'bdcomic_theme'); ?>
                    </button>
    ...
    <div class="collections-list">
        <?php if (empty($collections_data)): ?>
            <div class="collections-empty">
                ...
                <p><?php _e('Commencez par ajouter des livres à vos souhaits ou marquez-les comme lus.', 'bdcomic_theme'); ?>
                </p>
            </div>
        <?php else: ?>
                            ...
                            <div class="<?php echo implode(' ', $book_classes); ?>" data-book-id="<?php echo $book->ID; ?>"
                                ...
                                <div class="book-cover">
                                    ...
                                    <div class="book-action-icons">
                                        <button class="book-action-icon report-problem-btn" data-book-id="<?php echo $book->ID; ?>"
