            ...
            <?php if ($social_networks): ?>
                <div class="footer-social-networks">
                    <?php if (!empty($social_networks['facebook'])): ?>
                        <a href="<?php echo esc_url($social_networks['facebook']); ?>" target="_blank" rel="noopener"
                    ...
                    <?php if (!empty($social_networks['instagram'])): ?>
                        <a href="<?php echo esc_url($social_networks['instagram']); ?>" target="_blank" rel="noopener"
                    ...
                    <?php if (!empty($social_networks['youtube'])): ?>
                        <a href="<?php echo esc_url($social_networks['youtube']); ?>" target="_blank" rel="noopener"
            ...
            <?php else: ?>
                <div class="footer-copyright">
                    <p>&copy; <?php echo date('Y'); ?>     <?php bloginfo('name'); ?>.
                        <?php esc_html_e('Tous droits réservés.', 'mondeft_theme'); ?>
                    </p>
                </div>
            <?php endif; ?>
        </div>
