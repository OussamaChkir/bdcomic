                    ...
                    <div class="user-books-list-container">
                                        ...
                                        <div class="user-books-list-item-info">
                                            <?php if ($photo_devant): ?>
                                                <img src="<?php echo esc_url($photo_devant['sizes']['thumbnail']); ?>"
                                                    alt="<?php echo esc_attr($photo_devant['alt']); ?>" class="book-thumbnail">
                                            <?php endif; ?>
                                            <div class="book-details">
                                                ...
                                                <div class="user-books-list-item-meta">
                                                    Ajouté le
                                                    <?php echo date_i18n(get_option('date_format'), strtotime($book_data['added_date'])); ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="user-books-list-item-actions">
                                            <button class="book-action-btn active" data-post-id="<?php echo $book->ID; ?>"
                                                data-list-type="wishlist" data-action="remove" data-post-type="livre">
                        ...
                        <?php else: ?>
                            <div class="user-books-empty">
                                ...
                                <p><?php _e('Commencez à explorer nos livres et ajoutez ceux qui vous intéressent à vos souhaits.', 'bdcomic_theme'); ?>
                                </p>
                    ...
                    <div class="user-books-list-container">
                            ...
                            <ul class="user-books-list">
                                <?php foreach ($read_books as $book_data):
                                    ...
                                    <li class="user-books-list-item">
                                        ...
                                        <div class="user-books-list-item-actions">
                                            <button class="book-action-btn active" data-post-id="<?php echo $book->ID; ?>"
                                                data-list-type="read" data-action="remove" data-post-type="livre">
                        ...
                        <?php else: ?>
                            <div class="user-books-empty">
                                ...
                                <p><?php _e('Marquez les livres que vous avez lus pour suivre vos lectures.', 'bdcomic_theme'); ?>
                                </p>
                                <a href="<?php echo get_post_type_archive_link('livre'); ?>" class="btn btn-primary">
                                    <?php _e('Explorer les livres', 'bdcomic_theme'); ?>
                                </a>
                    ...
                    <div class="user-books-list-container">
                                        ...
                                        <div class="user-books-list-item-info">
                                            <?php if ($logo): ?>
                                                <img src="<?php echo esc_url($logo['sizes']['thumbnail']); ?>"
                                                    alt="<?php echo esc_attr($logo['alt']); ?>" class="book-thumbnail">
                                            <?php endif; ?>
                                            <div class="book-details">
                                                <h4 class="user-books-list-item-title">
                                                ...
                                                <div class="user-books-list-item-meta">
                                                    Ajouté le
                                                    <?php echo date_i18n(get_option('date_format'), strtotime($collection_data['added_date'])); ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="user-books-list-item-actions">
                                            <button class="book-action-btn active" data-post-id="<?php echo $collection->ID; ?>"
                                                data-list-type="collection_wishlist" data-action="remove"
                        ...
                        <?php else: ?>
                            <div class="user-books-empty">
                                ...
                                <p><?php _e('Ajoutez des collections à vos souhaits pour suivre leurs nouveaux albums.', 'bdcomic_theme'); ?>
                                </p>
