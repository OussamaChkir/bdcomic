                        ...
                        <?php if (current_user_can('administrator') || current_user_can('editor')): ?>
                            ...
                            <div class="livre-meta-details" style="margin-top: 2rem;">
                                ...
                                <ul class="meta-list">
                                    ...
                                    <li>
                                        <strong>Lu par:</strong> <?php echo intval($book_stats['read']); ?> utilisateur(s)
                                    </li>
                                    <li>
                                        <strong>Dans les souhaits de:</strong> <?php echo intval($book_stats['wishlist']); ?> utilisateur(s)
                                    </li>
                                    <li>
                                        <strong>Prêté par:</strong> <?php echo intval($book_stats['loaned']); ?> utilisateur(s)
                                    </li>
                                </ul>
                            </div>
                        <?php endif; ?>
